...
const Bedroom = () => {
    ...
    const toggleLight = (light) => {
        const newState = {
            bedroom: { ...bedroom, [light]: !bedroom[light] },
        };
    ...
    return (
        <div className="border border-gray-500 p-4 rounded-lg w-[90%] md:w-[45%]">
            <h3 className="text-center font-semibold text-xl my-3">Bedroom</h3>
            ...
            <div className="w-[90%] flex flex-wrap justify-center items-center mx-auto mt-4">
                <MyButton
                    label="Both On"
                    onClick={turnOnBoth}
                    isOn={bedroom.light1 && bedroom.light2} // Both lights are on
                />
                <MyButton
                    label="Both Off"
                    onClick={turnOffBoth}
                    isOn={!bedroom.light1 && !bedroom.light2} // Both lights are off
                />
